  ...
  const socialLinks = [
    {
      name: 'Spotify',
      icon: <MusicNote />,
      url: 'https://open.spotify.com/artist/your-artist-id', // Replace with your Spotify URL
      color: '#1DB954'
    },
    {
      name: 'Apple Music',
      icon: <Apple />,
      url: 'https://music.apple.com/artist/your-artist-id', // Replace with your Apple Music URL
      color: '#FA243C'
    },
    {
      name: 'Amazon Music',
    ...
    },
    {
      name: 'Instagram',
      icon: <Instagram />,
      url: 'https://instagram.com/your-handle', // Replace with your Instagram URL
      color: '#E4405F'
    },
    {
      name: 'TikTok',
      ...
      url: 'https://tiktok.com/@your-handle', // Replace with your TikTok URL
      color: '#000000'
    },
    {
      name: 'Bandcamp',
